    ...
    >
      ...
      <div className="p-3 sm:p-4 md:p-5 flex flex-col flex-1">
        ...
        <div className="mt-auto pt-3 sm:pt-4 md:pt-5 flex justify-between items-center gap-2">
          <div>
            <span className="text-base sm:text-lg text-[#364a82] font-bold">
              ₹{price}
            </span>
            <span className="text-xs sm:text-sm text-gray-500"> /month</span>
          </div>

          <button className="bg-[#364a82] hover:bg-[#d28c14] text-white py-1 sm:py-1.5 px-3 sm:px-4 rounded text-xs sm:text-sm transition cursor-pointer flex-shrink-0">
            View Details
          </button>
        </div>
      </div>
