    ...
    <div className="relative bg-[#132350] text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-12 sm:py-20 lg:py-32">
        ...
        <p className="mt-4 sm:mt-6 text-gray-300 text-sm sm:text-base text-center max-w-2xl mx-auto">
          Explore a curated selection of premium, cost-effective PG residences
          and contemporary apartments, designed for comfort, convenience and
          reliable service.
        </p>

        <div className="mt-8 sm:mt-10 max-w-3xl mx-auto bg-white/20 backdrop-blur-md rounded-lg shadow-md border border-white/30 p-3 sm:p-4">
          ...
          <div className="my-4 lg:my-6">
            <h2 className=" text-white text-lg font-bold sm:text-base italic mb-3">
              Included Amenities:
            </h2>
